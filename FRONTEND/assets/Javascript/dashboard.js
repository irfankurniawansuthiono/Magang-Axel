      ...
      if (Array.isArray(images) && images.length > 0) {
        images.forEach((imgData, index) => {
          ...
          row.innerHTML = `
            ...
            <td style="width: 30%; text-align: center">${imgData.imageAlt}</td>
            <td style="width: 40%; padding: 30px; text-align: center"><img src="${imgData.imageUrl}" alt="${imgData.imageAlt}" loading="lazy" width="100%" height="100%"></td>
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        row.innerHTML = `
            ...
            <td style="width: 40%; padding: 30px; text-align: center"><img src="${source}" alt="${imageAlt}" loading="lazy" width="100%" height="100%"></td>
            <td style="height: 100%; text-align: center; display: flex; gap: 5px;">
